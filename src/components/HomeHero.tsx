  ...
  return (
    <section className="relative h-screen flex items-center overflow-hidden bg-black">
      ...
      <div className="max-w-7xl mx-auto px-8 relative z-10 w-full">
        ...
        <h1 ref={titleRef} className="reveal font-serif font-light leading-[0.92] tracking-tight mb-8">
        ...
        <p ref={textRef} className="reveal text-white/50 text-base leading-relaxed mb-12 max-w-sm">
          {t("hero.subtitle")}
        </p>
