        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center min-h-[80vh] py-32">
          ...
          <div className="lg:pl-8 lg:border-l lg:border-white/10 space-y-8">
            ...
            <div className="grid grid-cols-3 gap-6 py-6 border-t border-b border-white/10">
              ...
              <div>
                <div className="text-[#b8860b] font-serif text-3xl font-light leading-none mb-1.5">
                  100+
                </div>
                <div className="text-white/40 text-[11px] tracking-widest uppercase leading-none mb-0.5">
                  Национальностей
                </div>
                <div className="text-white/25 text-[10px] tracking-normal normal-case leading-none">
                  рекорд Гиннесса
                </div>
              </div>
              ...
              <div>
                ...
                <div className="text-white/40 text-[11px] tracking-widest uppercase leading-none">
                  Казахстан
                </div>
              </div>
